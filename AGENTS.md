...
You are working in the Paragon Sciences Astro codebase. Follow these rules for all changes.
...
- Content editing: Pages CMS (frontmatter-driven content).

## Goals
- Reproduce the WordPress information architecture and content hierarchy.
- Preserve headings, copy, and terminology from the source site unless asked to rewrite.
...
- Keep fields explicit and consistent (title, description, slug, hero, sections, cta).
- Avoid magic strings in components; pass content from frontmatter or data files.
